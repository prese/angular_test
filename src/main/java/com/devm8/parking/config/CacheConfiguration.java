package com.devm8.parking.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.devm8.parking.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.devm8.parking.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
